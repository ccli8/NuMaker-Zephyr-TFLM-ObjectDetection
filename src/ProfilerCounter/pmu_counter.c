...
/* On zephyr, ethos-u driver is not available for non-vela-compile model */
...
/*
 * On zephyr, SysTick is exclusively used by zephyr kernel. Use zephyr
 * kernel timing api instead. See:
