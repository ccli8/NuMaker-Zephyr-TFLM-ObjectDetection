...
/* Externalize ethosu_drv on both zephyr and bsp */
#if defined(__ZEPHYR__)
struct ethosu_driver *ethosu_drv_p;
#else
struct ethosu_driver ethosu_drv; /* Default Ethos-U device driver */
struct ethosu_driver *ethosu_drv_p = &ethosu_drv;
#endif
...
{
    /* Acquire ethosu_driver on zephyr
     *
     * On zephyr, ethosu_driver is encapsulated in ethos-u zephyr
     * driver and is invisible from app. Use this trick to acquire it.
     */
    ethosu_drv_p = ethosu_reserve_driver();
    ethosu_release_driver(ethosu_drv_p);
}
#else
/*
